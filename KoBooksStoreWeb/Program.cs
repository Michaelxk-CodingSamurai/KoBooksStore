...
builder.Services.AddDbContext<KoBooksStoreDbContext>(options => options.UseSqlServer(
    builder.Configuration.GetConnectionString("KoBooksStoreConnection")
        ));
...
SeedGenres.EnsurePopulated(app);
